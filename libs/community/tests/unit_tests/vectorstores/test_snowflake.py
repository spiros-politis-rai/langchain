...
def test_as_retriever(snowflake_vector_store: SnowflakeVectorStore
) -> None:
    """Test converting Snowflake vector store to retriever."""

    # Expecting a VectorStoreRetriever instance.
    assert isinstance(
        snowflake_vector_store.as_retriever(
...
def test_similarity_search(
    ...
    """Test performing similarity search with the Snowflake vector store."""
    result = snowflake_vector_store.similarity_search(
