...
def test_snowflake_embed_query_768(
    ...
    assert result is not None \
        and len(result) == snowflake_embeddings_768.embeddings_dim
...
def test_snowflake_embed_query_1024(
    ...
    assert result is not None \
        and len(result) == snowflake_embeddings_1024.embeddings_dim
